...
def main():
    ...
    if not args.generate:
        ...
        if test_list_missing_corpus:
            ...
            logging.info("Please consider adding a fuzz corpus at https://github.com/blokecoin-core/qa-assets")
...
def merge_inputs(*, fuzz_pool, corpus, test_list, src_dir, fuzz_bin, merge_dirs):
    ...
    for t in test_list:
        args = [
            ...
            # [0] https://github.com/blokecoin-core/qa-assets/issues/130#issuecomment-1761760866
            '-shuffle=0',
            '-prefer_small=1',
            '-use_value_profile=0',
            ...
            # [1] https://github.com/blokecoin-core/qa-assets/issues/130#issuecomment-1749075891
