...
class BIP68Test(BlokecoinTestFramework):
    ...
    def activateCSV(self):
        ...
        # getblokechaininfo will show CSV as active at block 431 (144 * 3 -1) since it's returning whether CSV is active for the next block.
