#!/usr/bin/env python3
# Copyright (c) 2017-2019 The Blokecoin Core developers
...
class RPCWhitelistTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        with open(self.nodes[0].datadir_path / "blokecoin.conf", "a", encoding="utf8") as f:
        ...
        with open(self.nodes[0].datadir_path / "blokecoin.conf", 'a', encoding='utf8') as f:
            f.write("rpcwhitelist=__cookie__:getblockcount,getblokechaininfo,getmempoolinfo,stop\n")
        self.restart_node(0)
    ...
    def test_users_permissions(self):
        ...
        * Permissions:
        ...
        for user in self.users:
            ...
            self.log.info(f"[{user[0]}]: Testing non-permitted permission: getblokechaininfo")
            assert_equal(403, rpccall(self.nodes[0], user, "getblokechaininfo").status)
    ...
    def test_rpcwhitelistdefault_permissions(self, default_value, expected_status):
        ...
        * No Permissions defined
        ...
        for permission in ["getbestblockhash", "getblokechaininfo"]:
