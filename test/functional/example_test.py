...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BlokecoinTestFramework
    pass


class ExampleTest(BlokecoinTestFramework):
    # Each functional test is a subclass of the BlokecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BlokecoinTestFramework class so other tests can use it."""
