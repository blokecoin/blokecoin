...
class InvalidAddressErrorMessageTest(BlokecoinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        if not self.options.usecli:
            ...
            assert_raises_rpc_error(-1, "Return information about the given blokecoin address.", node.validateaddress)
