...
class GetBlockFromPeerTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.sync_blocks([self.nodes[0], pruned_node])
        pruneheight = pruned_node.pruneblokechain(300)
        ...
        self.sync_blocks([self.nodes[0], pruned_node])
        pruneheight += 251
        assert_equal(pruned_node.pruneblokechain(700), pruneheight)
        ...
        self.sync_blocks([self.nodes[0], pruned_node])
        pruneheight += 250
        assert_equal(pruned_node.pruneblokechain(1000), pruneheight)
        assert_raises_rpc_error(-1, "Block not available (pruned data)", pruned_node.getblock, pruned_block)
