#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Blokecoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting blokecoin with -h works as expected."""

from test_framework.test_framework import BlokecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blokecoin with -h for help text")
        ...
        self.log.info("Start blokecoin with -version for version information")
        ...
        self.log.info("Start blokecoind with -fakearg to make sure it does not start")
