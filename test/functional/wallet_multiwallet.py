...
Verify that a blokecoind node can load multiple wallet files
"""
...
class MultiWalletTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        batch = w1.batch([w1.getblokechaininfo.get_request(), w1.getwalletinfo.get_request()])
