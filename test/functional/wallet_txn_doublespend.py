...
class TxnMallTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        # blokechain sync later in the test when nodes are connected, due to
        # timing issues.
        for n in self.nodes:
            assert n.getblokechaininfo()["initialblockdownload"] == False
