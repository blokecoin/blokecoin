...
class BlokecoinChainstateTest(BlokecoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_blokecoin_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing blokecoin-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    BlokecoinChainstateTest(__file__).main()
