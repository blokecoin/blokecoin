#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Blokecoin Core developers
...
class TxDownloadTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new blokecoind instances, as setting mocktimes has long-term effects on when
