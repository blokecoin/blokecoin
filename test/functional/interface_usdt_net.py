#!/usr/bin/env python3
# Copyright (c) 2022-present The Blokecoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

"""  Tests the net:* tracepoint API interface.
     See https://github.com/blokecoin/blokecoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BlokecoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_blokecoind_tracepoints()
    ...
    def p2p_message_tracepoint_test(self):
        ...
        self.log.info("connect a P2P test node to our blokecoind node")
    ...
    def inbound_conn_tracepoint_test(self):
        ...
        self.log.info("connect two P2P test nodes to our blokecoind node")
        testnodes = list()
    ...
    def outbound_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {EXPECTED_OUTBOUND_CONNECTIONS} P2P test nodes to our blokecoind node")
        testnodes = list()
    ...
    def evicted_inbound_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {MAX_INBOUND_CONNECTIONS + EXPECTED_EVICTED_CONNECTIONS} P2P test nodes to our blokecoind node and expect {EXPECTED_EVICTED_CONNECTIONS} evictions")
        testnodes = list()
    ...
    def misbehaving_conn_tracepoint_test(self):
        ...
        self.log.info("connect a misbehaving P2P test nodes to our blokecoind node")
    ...
    def closed_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {EXPECTED_CLOSED_CONNECTIONS} P2P test nodes to our blokecoind node")
        testnodes = list()
