#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Blokecoin Core developers
...
class InvalidMessagesTest(BlokecoinTestFramework):
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure blokecoind signals support for ADDRv2, otherwise this test
    ...
    def test_invalid_pow_headers_msg(self):
        ...
        assert_equal(self.nodes[0].getblokechaininfo()['headers'], 0)
        ...
        assert_equal(self.nodes[0].getblokechaininfo()['headers'], 1)
