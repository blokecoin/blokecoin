...
"""
Test starting blokecoind with -bind and/or -bind=...=onion, confirm that
...
class BindExtraTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that blokecoind has bound on "::1" (for RPC) and "::" (for P2P).
