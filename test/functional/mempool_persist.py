...
By default, blokecoind will dump mempool on shutdown and
...
class MempoolPersistTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent blokecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
