#!/usr/bin/env python3
# Copyright (c) 2016-2020 The Blokecoin Core developers
...
class NamedArgumentTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        node = self.nodes[0]
        h = node.help(command='getblokechaininfo')
        assert h.startswith('getblokechaininfo\n')

        assert_raises_rpc_error(-8, 'Unknown named parameter', node.help, random='getblokechaininfo')
