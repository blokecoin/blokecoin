...
Verify that a blokecoind node can use an external signer command.
...
class RPCSignerTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart blokecoind with -signer=<cmd>',
