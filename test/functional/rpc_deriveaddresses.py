...
class DeriveaddressesTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Before #26275, blokecoind would crash when deriveaddresses was
        # called with derivation index 2147483647, which is the maximum
        # positive value of a signed int32, and - currently - the
        # maximum value that the deriveaddresses blokecoin RPC call
