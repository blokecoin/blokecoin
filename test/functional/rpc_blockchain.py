...
"""Test RPCs related to blokechainstate.
...
Tests correspond to code in rpc/blokechain.cpp.
"""
...
class BlokechainTest(BlokecoinTestFramework):
    ...
    def mine_chain(self):
        ...
        assert_equal(self.nodes[0].getblokechaininfo()['blocks'], HEIGHT)
    ...
    def _test_getblokechaininfo(self):
        self.log.info("Test getblokechaininfo")
        ...
        res = self.nodes[0].getblokechaininfo()
    ...
    def _test_getdeploymentinfo(self):
        ...
        gbci207 = self.nodes[0].getblokechaininfo()
        ...
        gbci287 = self.nodes[0].getblokechaininfo()
    ...
    def _test_verificationprogress(self):
        ...
        future = 2 * 60 * 60
        self.nodes[0].setmocktime(self.nodes[0].getblokechaininfo()["time"] + future + 1)
        assert_greater_than(1, self.nodes[0].getblokechaininfo()["verificationprogress"])

        self.log.info("Check that verificationprogress is exactly 1 for a recent block tip")
        self.nodes[0].setmocktime(self.nodes[0].getblokechaininfo()["time"] + future)
        assert_equal(1, self.nodes[0].getblokechaininfo()["verificationprogress"])
    ...
    def _test_gettxoutsetinfo(self):
        ...
        self.log.info("Test gettxoutsetinfo works for blokechain with just the genesis block")
    ...
    def _test_waitforblockheight(self):
        ...
        # `rpc/blokechain.cpp:latestblock` incorrectly.)
        #
