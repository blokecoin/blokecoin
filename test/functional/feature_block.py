...
class FullBlockTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure blokecoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure blokecoind isn't accepting b28
        ...
        # blokecoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the blokecoin code has custom code which does so);
