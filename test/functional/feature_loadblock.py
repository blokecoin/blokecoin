#!/usr/bin/env python3
# Copyright (c) 2017-2021 The Blokecoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test loadblock option

Test the option to start a node with the option loadblock which loads
a serialized blokechain from a file (usually called bootstrap.dat).
...
class LoadblockTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[1].getblokechaininfo()['blocks'], 100)
