...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The blokecoind node closes feeler connections as soon as a version
...
class P2PAddConnections(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        # blokecoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that blokecoind sends its own version prior to processing
