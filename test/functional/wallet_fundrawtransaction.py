...
class RawTransactionsTest(BlokecoinTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "Change address must be a valid blokecoin address", self.nodes[2].fundrawtransaction, rawtx, changeAddress='foobar')
    ...
    def test_feerate_rounding(self):
        ...
        # fail with insufficient funds rather than blokecoind asserting.
