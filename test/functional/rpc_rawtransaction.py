...
class RawTransactionsTest(BlokecoinTestFramework):
    ...
    def getrawtransaction_tests(self):
        ...
        err_msg = (
            ...
            " blokechain transaction queries. Use gettransaction for wallet transactions."
        )
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # Do this with a pruned chain, as a regression test for https://github.com/blokecoin/blokecoin/pull/29003
        self.generate(self.nodes[2], 400)
        assert_greater_than(self.nodes[2].pruneblokechain(250), 0)
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Blokecoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/blokecoin/blokecoin/issues/20579)
