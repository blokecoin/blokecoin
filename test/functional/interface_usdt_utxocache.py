...
""" Tests the utxocache:* tracepoint API interface.
    See https://github.com/blokecoin/blokecoin/blob/master/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(BlokecoinTestFramework):
    ...
    def test_uncache(self):
        ...
        https://github.com/blokecoin/blokecoin/blob/master/doc/tracing.md#tracepoint-utxocacheuncache
        """
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See https://github.com/blokecoin/blokecoin/blob/master/doc/tracing.md#tracepoint-utxocacheadd
            and https://github.com/blokecoin/blokecoin/blob/master/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See https://github.com/blokecoin/blokecoin/blob/master/doc/tracing.md#tracepoint-utxocacheflush"""
        ...
        self.log.info("prune blokechain to trigger a flush for pruning")
        expected_flushes.append({"mode": "NONE", "for_prune": True, "size": 0})
        self.nodes[0].pruneblokechain(315)
