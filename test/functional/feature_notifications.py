...
class NotificationsTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/blokecoin/blokecoin/pull/9371, it might be better
