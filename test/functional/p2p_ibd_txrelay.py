...
class P2PIBDTxRelayTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        for node in self.nodes:
            assert node.getblokechaininfo()['initialblockdownload']
        ...
        for node in self.nodes:
            assert not node.getblokechaininfo()['initialblockdownload']
