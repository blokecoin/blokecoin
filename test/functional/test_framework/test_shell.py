...
class TestShell:
    """Wrapper Class for BlokecoinTestFramework.

    The TestShell class extends the BlokecoinTestFramework
    ...
    class __TestShell(BlokecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BlokecoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # BlokecoinTestFramework instances are supposed to be constructed with the path
