...
This file is modified from python-blokecoinlib.
"""
...
def bn2vch(v):
    """Convert number to blokecoin-specific little endian format."""
...
# This is used, eg, for blokechain heights in coinbase scripts (bip34)
class CScriptNum:
    __slots__ = ("value",)
