...
class MiningTest(BlokecoinTestFramework):
    ...
    def test_timewarp(self):
        ...
        n = DIFFICULTY_ADJUSTMENT_INTERVAL - blokechain_info['blocks'] % DIFFICULTY_ADJUSTMENT_INTERVAL - 2
        t = blokechain_info['time']
    ...
    def test_pruning(self):
        ...
        pruned_height = prune_node.pruneblokechain(400)
