...
class VersionBitsWarningTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because blokecoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)

        # Generating one block guarantees that we'll get out of IBD
        self.generatetoaddress(node, 1, node_deterministic_address)
        self.wait_until(lambda: not node.getblokechaininfo()['initialblockdownload'])
