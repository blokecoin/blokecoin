...
class InvalidateTest(BlokecoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[0].getblokechaininfo()["headers"], self.nodes[0].getblokechaininfo()["blocks"] + 1)
        ...
        # Should report consistent blokechain info
        assert_equal(self.nodes[0].getblokechaininfo()["headers"], self.nodes[0].getblokechaininfo()["blocks"])
        ...
        assert_equal(self.nodes[0].getblokechaininfo()['blocks'], 3)
        assert_equal(self.nodes[0].getblokechaininfo()['headers'], 3)
        ...
        assert_equal(self.nodes[0].getbestblockhash(), blockhash_6)
        assert_equal(self.nodes[0].getblokechaininfo()['blocks'], 6)
        assert_equal(self.nodes[0].getblokechaininfo()['headers'], 7)
        ...
        assert_equal(self.nodes[1].getbestblockhash(), blocks[-1])
        # Should report consistent blokechain info
        assert_equal(self.nodes[1].getblokechaininfo()["headers"], self.nodes[1].getblokechaininfo()["blocks"])
