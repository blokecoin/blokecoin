...
```sh
DOCKER_BUILDKIT=1 docker build -t blokecoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/blokecoin -it blokecoin-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/blokecoin-core/crc32c-subtree.git (branch blokecoin-fork)
* for `src/crypto/ctaes`: https://github.com/blokecoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/blokecoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/blokecoin-core/leveldb-subtree.git (branch blokecoin-fork)
* for `src/minisketch`: https://github.com/blokecoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/blokecoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/blokecoin-core/secp256k1.git
```
