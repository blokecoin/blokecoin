...
Blokecoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Blokecoin Core

**When configuring Blokecoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Blokecoin Core:
...
variables will be set when generating the Blokecoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
