# Copyright (c) 2024-present The Blokecoin Core developers
...
execute_process(
  COMMAND ${LCOV_COMMAND} --capture --directory src --test-name test_blokecoin --output-file test_blokecoin.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
...
execute_process(
  COMMAND ${LCOV_FILTER_COMMAND} test_blokecoin.info test_blokecoin_filtered.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
  COMMAND ${LCOV_COMMAND} --add-tracefile test_blokecoin_filtered.info --output-file test_blokecoin_filtered.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
  COMMAND ${LCOV_COMMAND} --add-tracefile baseline_filtered.info --add-tracefile test_blokecoin_filtered.info --output-file test_blokecoin_coverage.info
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
execute_process(
  COMMAND ${GENHTML_COMMAND} test_blokecoin_coverage.info --output-directory test_blokecoin.coverage
  WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCOV_COMMAND} --add-tracefile baseline_filtered.info --add-tracefile test_blokecoin_filtered.info --add-tracefile functional_test_filtered.info --output-file total_coverage.info
