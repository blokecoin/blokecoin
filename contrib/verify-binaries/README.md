...
As of Blokecoin Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/blokecoin-core/guix.sigs/). When
...
builder-keys](https://github.com/blokecoin-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://blokecoincore.org and https://blokecoin.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/blokecoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/blokecoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
