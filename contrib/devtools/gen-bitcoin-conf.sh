...
BITCOIND=${BITCOIND:-$BINDIR/blokecoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/blokecoin.conf}
...
then
  ...
  echo -e "To safely generate a blokecoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example blokecoin.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-blokecoin-conf.sh.
##
...
# parse the output from blokecoind --help
