...
"""Example logging Blokecoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/blokecoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[blokecoind_with_usdts])
