...
When complete, it will have produced `Blokecoin-Core.zip`.
...
apt install cpio
git clone https://github.com/blokecoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/blokecoin-core/blokecoin-detached-sigs).
