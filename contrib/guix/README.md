...
This directory contains the files necessary to perform bootstrappable Blokecoin
Core builds.
...
To build Blokecoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Blokecoin Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/blokecoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/blokecoin-core/guix.sigs).
