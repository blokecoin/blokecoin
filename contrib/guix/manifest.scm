...
(define* (make-blokecoin-cross-toolchain target
                                       #:key
...
desirable for building Blokecoin Core release binaries."
...
;; failure; see https://github.com/blokecoin/blokecoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-blokecoin-cross-toolchain target)))
