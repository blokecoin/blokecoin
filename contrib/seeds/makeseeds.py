#!/usr/bin/env python3
# Copyright (c) 2013-2022 The Blokecoin Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of blokecoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple blokecoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple blokecoin ports', file=sys.stderr)
