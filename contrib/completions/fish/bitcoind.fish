...
complete --command blokecoind --no-files

# Extract options
function __fish_blokecoind_get_options
...
complete \
    --command blokecoind \
    --arguments "(__fish_blokecoind_get_options --nofiles)"
