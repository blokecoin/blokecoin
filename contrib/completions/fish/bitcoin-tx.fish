...
# Extract options
function __fish_blokecoin_tx_get_options
...
# Extract commands
function __fish_blokecoin_tx_get_commands
...
# Add options
complete \
    --command blokecoin-tx \
    --condition "not __fish_blokecoin_seen_cmd (__fish_blokecoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_blokecoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command blokecoin-tx \
    --arguments "(__fish_blokecoin_tx_get_commands)" \
    --no-files
