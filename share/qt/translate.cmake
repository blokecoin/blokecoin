...
function(extract_strings output)
  ...
  file(STRINGS "blokecoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *blokecoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"blokecoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/blokecoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/blokecoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/blokecoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/blokecoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/blokecoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/blokecoin_en.xlf" blokecoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" blokecoin_en "${blokecoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" blokecoin_en "${blokecoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/blokecoin_en.xlf" "${blokecoin_en}")
