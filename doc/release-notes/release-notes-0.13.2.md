Blokecoin Core version 0.13.2 is now available from:

  <https://blokecoin.org/bin/blokecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update blokecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow blokecoin-tx to create v2 transactions (btcdrak)
