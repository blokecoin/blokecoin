Blokecoin Core version 27.0 is now available from:

  <https://blokecoincore.org/bin/blokecoin-core-27.0/>
...
libblokecoinconsensus
-------------------

- libblokecoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libblokecoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Blokecoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Blokecoin Core would
