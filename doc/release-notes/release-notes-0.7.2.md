Blokecoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/blokecoin/files/Blokecoin/blokecoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Blokecoin-Qt to crash on Windows when exiting.
