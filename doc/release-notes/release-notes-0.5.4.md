Blokecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/blokecoin/files/Blokecoin/blokecoin-0.5.4/
...
http://gitorious.org/blokecoin/blokecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Blokecoin-Qt notifications under Growl 1.3.
Increase required age of Blokecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBlokecoin properly when installing Blokecoin-Qt over it. (Windows)
