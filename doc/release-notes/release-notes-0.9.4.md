Blokecoin Core version 0.9.4 is now available from:

  https://blokecoin.org/bin/0.9.4/
...
this update is incompatible with the Blokecoin system and could lead to consensus
forks.

Blokecoin Core released binaries from https://blokecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~blokecoin/+archive/ubuntu/blokecoin
- A third-party or self-compiled Blokecoin Core

upgrade to Blokecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
