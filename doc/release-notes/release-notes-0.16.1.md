Blokecoin Core version 0.16.1 is now available from:

  <https://blokecoincore.org/bin/blokecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting blokecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure blokecoind processes are cleaned up when tests end (sdaftuar)
