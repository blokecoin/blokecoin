Blokecoin Core version 0.9.2 is now available from:

  https://blokecoin.org/bin/0.9.2/
...
0.9.2 your blokechain files will be re-indexed, which will take anywhere from 
