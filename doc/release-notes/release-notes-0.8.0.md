Blokecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/blokecoin/files/Blokecoin/blokecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Blokecoin
...
New/changed settings (command-line or blokecoin.conf file)
--------------------------------------------------------
...
or not to rescan the blokechain for transactions after importing a new private key.
