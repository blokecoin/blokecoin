Blokecoin Core version 0.18.1 is now available from:

  <https://blokecoincore.org/bin/blokecoin-core-0.18.1/>
...
### RPC and other APIs
- #15991 Bugfix: fix pruneblokechain returned prune height (jonasschnelli)
...
- #15947 Install blokecoin-wallet manpage (domob1812)
