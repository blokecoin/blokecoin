...
Blokecoin Core version 0.19.1 is now available from:

  <https://blokecoincore.org/bin/blokecoin-core-0.19.1/>
...
From Blokecoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Blokecoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Blokecoin Core does not yet change appearance when
...
- #17488 fix "blokecoind already running" warnings on macOS (fanquake)
