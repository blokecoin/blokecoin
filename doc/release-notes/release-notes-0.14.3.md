Blokecoin Core version *0.14.3* is now available from:

  <https://blokecoin.org/bin/blokecoin-core-0.14.3/>
...
Since 0.14.0 the approximate transaction fee shown in Blokecoin-Qt when using coin
...
- #9853 Return correct error codes in setban(), fundrawtransaction(), removeprunedfunds(), bumpfee(), blokechain.cpp (John Newbery)
...
- #10451 `3612219` contrib/init/blokecoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
