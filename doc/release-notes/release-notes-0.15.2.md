Blokecoin Core version *0.15.2* is now available from:

  <https://blokecoincore.org/bin/blokecoin-core-0.15.2/>
...
Blokecoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #11554 `a69cc07` Sanity-check script sizes in blokecoin-tx (TheBlueMatt)
