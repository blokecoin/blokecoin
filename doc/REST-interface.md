...
Refer to the `getblokechaininfo` RPC help for details.
...
See [BIP64](https://github.com/blokecoin/bips/blob/master/bip-0064.mediawiki) for
...
Risks
-------------
Running a web browser on the same node with a REST enabled blokecoind can be a risk. Accessing prepared XSS websites could read out tx/block data of your node by placing links like `<script src="http://127.0.0.1:8332/rest/tx/1234567890.json">` which might break the nodes privacy.
