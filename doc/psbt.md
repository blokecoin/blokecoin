# PSBT Howto for Blokecoin Core

Since Blokecoin Core 0.17, an RPC interface exists for Partially Signed Blokecoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/blokecoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Blokecoin transactions that are not fully signed
...
#### Multisig with multiple Blokecoin Core instances
