...
This document provides guidelines for internationalization of the Blokecoin Core software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `blokecoin_en.ts` remains unchanged.
