UNIX BUILD NOTES
====================
Some notes on how to build Blokecoin Core in Unix.
...
memory available when compiling Blokecoin Core. On systems with less, gcc can be
...
To build Blokecoin Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Blokecoin Core can
...
This example lists the steps necessary to setup and build a command line only distribution of the latest changes on Arch Linux:
    ...
    ./build/bin/blokecoind
    ./build/bin/blokecoin help
