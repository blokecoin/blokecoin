...
* Only limited package replacements are currently considered. (#28984)
   ...
   - Must improve [feerate diagram](https://delvingblokecoin.org/t/mempool-incentive-compatibility/553). (#29242)
...
[TRUC transactions](https://github.com/blokecoin/bips/blob/master/bip-0431.mediawiki) as an individual
