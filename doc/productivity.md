...
```sh
cmake --build build --target blokecoind blokecoin-cli
cmake --build build --target blokecoin-qt
cmake --build build --target bench_blokecoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:blokecoin/blokecoin.git
```
...
> e.g. github.com/blokecoin/blokecoin.git or for the GUI github.com/blokecoin-core/gui
