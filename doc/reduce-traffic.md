...
By default, Blokecoin Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that blokecoin's trustless model works best if you are
