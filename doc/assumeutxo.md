...
Assumeutxo is a feature that allows fast bootstrapping of a validating blokecoind
instance.
...
```
$ blokecoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ blokecoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
