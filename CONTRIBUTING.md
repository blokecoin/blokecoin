Contributing to Blokecoin Core
============================

The Blokecoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Blokecoin Core
...
Before you start contributing, familiarize yourself with the Blokecoin Core build
system and tests. Refer to the documentation in the repository on how to build
Blokecoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/blokecoin/blokecoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/blokecoin/blokecoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the [Blokecoin Core PR Review Club](https://blokecoincore.reviews/).
...
Most communication about Blokecoin Core development happens on IRC, in the
`#blokecoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#blokecoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/blokecoin-core-dev/](https://www.erisian.com.au/blokecoin-core-dev/)
and [https://gnusha.org/blokecoin-core-dev/](https://gnusha.org/blokecoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/blokecoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/blokecoindev/](https://gnusha.org/pi/blokecoindev/).
...
For GUI-related issues or pull requests, the https://github.com/blokecoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/blokecoin/blokecoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to blokecoin-qt
...
fork of Blokecoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/blokecoin/blokecoin/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/blokecoin/blokecoin  # Fetch the latest upstream commit
...
The following applies to code changes to the Blokecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Blokecoin
Network Protocol consensus changes.

Whether a pull request is merged into Blokecoin Core rests with the project merge
maintainers.
...
Patches that change Blokecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Blokecoin consensus, it must have been
...
https://github.com/blokecoin/blokecoin/pull/16189).

Also see the [backport.py script](
https://github.com/blokecoin-core/blokecoin-maintainer-tools#backport).
