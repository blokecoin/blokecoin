 ...
 *  Blokecoin because since the activation of BIP66, signatures are verified to be
 *  strict DER before being passed to this module, and we know it supports all
 *  violations present in the blokechain before that point.
 */
...
bool CPubKey::Verify(const uint256 &hash, const std::vector<unsigned char>& vchSig) const {
     ...
     * not historically been enforced in Blokecoin, so normalize them first. */
