...
int main(int argc, char** argv)
{
    ...
    if (HelpRequested(argsman)) {
        std::cout << "Usage:  bench_blokecoin [options]\n"
                     "\n"
                  << argsman.GetHelpMessage()
                  << "Description:\n"
                     "\n"
                     "  bench_blokecoin executes microbenchmarks. The quality of the benchmark results\n"
                     ...
                     "\n"
                     "  * bench_blokecoin uses nanobench [3] for which there is extensive\n"
                     ...
                     "\n"
                     "    NANOBENCH_ENDLESS=MuHash ./bench_blokecoin -filter=MuHash\n"
                     "\n"
                     ...
                     "\n"
                     "    NANOBENCH_SUPPRESS_WARNINGS=1 ./bench_blokecoin\n"
                     "\n"
                     "Notes:\n"
                     "\n"
                     "  1. pyperf\n"
