...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // blokecoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/blokecoin/blokecoin/issues/16220 about ways to
        ...
        // Show an error or warn/log if there is a blokecoin.conf file in the
