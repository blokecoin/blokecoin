 ...
 *
 * This header currently exposes an API for interacting with parts of Blokecoin
 ...
 * also not yet included in releases of Blokecoin Core.
 *
...
/**
 * Function signature for the global logging callback. All blokecoin kernel
