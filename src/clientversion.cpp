 ...
 * for both blokecoind and blokecoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <blokecoin-build-info.h>
// The <blokecoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/blokecoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Blokecoin Core copyright is not removed by accident
    if (copyright_devs.find("Blokecoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Blokecoin Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/blokecoin/blokecoin>";
