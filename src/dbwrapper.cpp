// Copyright (c) 2012-present The Blokecoin Core developers
...
class CBlokecoinLevelDBLogger : public leveldb::Logger {
public:
    ...
    void Logv(const char * format, va_list ap) override {
            ...
            for (int iter = 0; iter < 2; iter++) {
                ...
                if (p < limit) {
                    ...
                    // Do not use vsnprintf elsewhere in blokecoin source code, see above.
...
static leveldb::Options GetOptions(size_t nCacheSize)
{
    ...
    options.info_log = new CBlokecoinLevelDBLogger();
