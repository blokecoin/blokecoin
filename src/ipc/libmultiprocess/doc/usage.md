...
- An **API definition** declaring how the interface is called. Included examples: [calculator.h](../example/calculator.h), [printer.h](../example/printer.h), [init.h](../example/init.h). Blokecoin examples: [node.h](https://github.com/blokecoin/blokecoin/blob/master/src/interfaces/node.h), [wallet.h](https://github.com/blokecoin/blokecoin/blob/master/src/interfaces/wallet.h), [echo.h](https://github.com/blokecoin/blokecoin/blob/master/src/interfaces/echo.h), [init.h](https://github.com/blokecoin/blokecoin/blob/master/src/interfaces/init.h).

- A **data definition** declaring how interface calls get sent across the wire. Included examples: [calculator.capnp](../example/calculator.capnp), [printer.capnp](../example/printer.capnp), [init.capnp](../example/init.capnp). Blokecoin examples: [node.capnp](https://github.com/ryanofsky/blokecoin/blob/ipc-export/src/ipc/capnp/node.capnp), [wallet.capnp](https://github.com/ryanofsky/blokecoin/blob/ipc-export/src/ipc/capnp/wallet.capnp), [echo.capnp](https://github.com/blokecoin/blokecoin/blob/master/src/ipc/capnp/echo.capnp), [init.capnp](https://github.com/blokecoin/blokecoin/blob/master/src/ipc/capnp/init.capnp).
