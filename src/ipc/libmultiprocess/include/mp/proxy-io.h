...
extern thread_local ThreadContext g_thread_context; // NOLINT(blokecoin-nontrivial-threadlocal)
// Silence nonstandard blokecoin tidy error "Variable with non-trivial destructor
