 ...
 *
 * See https://blokecointalk.org/index.php?topic=8392.msg127623#msg127623
 *
...
bool static IsLowDERSignature(const valtype &vchSig, ScriptError* serror) {
    ...
    // https://blokecoin.stackexchange.com/a/12556:
...
bool GenericTransactionSignatureChecker<T>::CheckLockTime(const CScriptNum& nLockTime) const
{
    ...
    // transaction would be allowed into the blokechain, making
