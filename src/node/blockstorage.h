...
private:
    ...
    /* Calculate the block/rev files to delete based on height specified by user with RPC command pruneblokechain */
     ...
     * (which in this case means the blokechain must be re-downloaded.)
     *
