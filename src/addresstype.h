 ...
 *  A CTxDestination is the internal data type encoded in a blokecoin address
 */
...
/**
 * Generate a Blokecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
