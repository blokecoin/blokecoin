...
#include <algorithm>
#include <attributes.h> // Added for Blokecoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Blokecoin Core
#include <util/string.h> // Added for Blokecoin Core
...
// Added for Blokecoin Core. Similar to std::runtime_format from C++26.
...
// Added for Blokecoin Core. Wrapper for checking format strings at compile time.
