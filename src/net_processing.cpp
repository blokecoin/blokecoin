...
void PeerManagerImpl::ProcessGetData(CNode& pfrom, Peer& peer, const std::atomic<bool>& interruptMsgProc)
{
    ...
    if (it != peer.m_getdata_requests.end() && !pfrom.fPauseSend) {
        ...
        // https://blokecoincore.org/en/2024/07/03/disclose-getdata-cpu.
    }
...
// hours with specially crafted transactions. See https://blokecoincore.org/en/2024/07/03/disclose-orphan-dos.
