...
#### Added
 - New module `musig` implements the MuSig2 multisignature scheme according to the [BIP 327 specification](https://github.com/blokecoin/bips/blob/master/bip-0327.mediawiki). See:
...
#### Added
  - Added tests against [Project Wycheproof's](https://github.com/C2SP/wycheproof/) set of ECDSA test vectors (Blokecoin "low-S" variant), a fixed set of test cases designed to trigger various edge cases.
...
[unreleased]: https://github.com/blokecoin-core/secp256k1/compare/v0.7.0...HEAD
[0.7.0]: https://github.com/blokecoin-core/secp256k1/compare/v0.6.0...v0.7.0
[0.6.0]: https://github.com/blokecoin-core/secp256k1/compare/v0.5.1...v0.6.0
[0.5.1]: https://github.com/blokecoin-core/secp256k1/compare/v0.5.0...v0.5.1
[0.5.0]: https://github.com/blokecoin-core/secp256k1/compare/v0.4.1...v0.5.0
[0.4.1]: https://github.com/blokecoin-core/secp256k1/compare/v0.4.0...v0.4.1
[0.4.0]: https://github.com/blokecoin-core/secp256k1/compare/v0.3.2...v0.4.0
[0.3.2]: https://github.com/blokecoin-core/secp256k1/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/blokecoin-core/secp256k1/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/blokecoin-core/secp256k1/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/blokecoin-core/secp256k1/compare/423b6d19d373f1224fd671a982584d7e7900bc93..v0.2.0
[0.1.0]: https://github.com/blokecoin-core/secp256k1/commit/423b6d19d373f1224fd671a982584d7e7900bc93
