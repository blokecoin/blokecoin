 ...
 *  Blokecoin Improvement Proposal 340 "Schnorr Signatures for secp256k1"
 *  (https://github.com/blokecoin/bips/blob/master/bip-0340.mediawiki).
 */
...
/** An implementation of the nonce generation function as defined in Blokecoin
