...
def should_skip_flags(test_vector_flags):
    ...
    # for more details, see https://github.com/blokecoin-core/secp256k1/pull/1492#discussion_r1572491546
...
def should_skip_tcid(test_vector_tcid):
    ...
    # not care testing those. See https://github.com/blokecoin-core/secp256k1/pull/1492#discussion_r1572491546
