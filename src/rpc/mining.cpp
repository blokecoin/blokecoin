...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated blokecoin to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated blokecoin to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " CLIENT_NAME " wallet, you can get a new address to send the newly generated blokecoin to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated blokecoin to."},
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{
        ...
        "    https://github.com/blokecoin/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/blokecoin/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/blokecoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/blokecoin/bips/blob/master/bip-0145.mediawiki\n",
        {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!lpval.isNull()) {
         ...
         *
         * getblocktemplate is unlikely to be called by blokecoin-cli, so
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{
        ...
        "See https://en.blokecoin.it/wiki/BIP_0022 for full specification.\n",
        {
