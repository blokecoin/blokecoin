...
// Copyright (c) 2009-present The Blokecoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include <rpc/blokechain.h>
...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (blokecoin-cli -rpcclienttimeout=0)",
                {
        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Blokecoin address (only if a well-defined address exists)"},
...
static RPCHelpMan pruneblokechain()
{
    return RPCHelpMan{"pruneblokechain",
            ...
            "                  to prune blocks whose block time is at least 2 hours older than the provided timestamp."},
                ...
                RPCExamples{
                    HelpExampleCli("pruneblokechain", "1000")
            + HelpExampleRpc("pruneblokechain", "1000")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ChainstateManager& chainman = EnsureAnyChainman(request.context);
    ...
    if (chainHeight < chainman.GetParams().PruneAfterHeight()) {
        throw JSONRPCError(RPC_MISC_ERROR, "Blokechain is too short for pruning.");
    } else if (height > chainHeight) {
        throw JSONRPCError(RPC_INVALID_PARAMETER, "Blokechain is shorter than the attempted prune height.");
...
RPCHelpMan getblokechaininfo()
{
    return RPCHelpMan{"getblokechaininfo",
        "Returns an object containing various state info regarding blokechain processing.\n",
        {},
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                (IsDeprecatedRPCEnabled("warnings") ?
                    RPCResult{RPCResult::Type::STR, "warnings", "any network and blokechain warnings (DEPRECATED)"} :
                    RPCResult{RPCResult::Type::ARR, "warnings", "any network and blokechain warnings (run with `-deprecatedrpc=warnings` to return the latest warning as a single string)",
                    {
        ...
        RPCExamples{
            HelpExampleCli("getblokechaininfo", "")
            + HelpExampleRpc("getblokechaininfo", "")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ChainstateManager& chainman = EnsureAnyChainman(request.context);
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (blokecoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (blokecoin-cli -rpcclienttimeout=0)",
        {
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/blokecoin/blokecoin/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/blokecoin/blokecoin/issues/25675
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable blokecoind instance that is current with the network tip in a "
        ...
        "document (<https://github.com/blokecoin/blokecoin/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
...
void RegisterBlokechainRPCCommands(CRPCTable& t)
{
    static const CRPCCommand commands[]{
        {"blokechain", &getblokechaininfo},
        {"blokechain", &getchaintxstats},
        {"blokechain", &getblockstats},
        {"blokechain", &getbestblockhash},
        {"blokechain", &getblockcount},
        {"blokechain", &getblock},
        {"blokechain", &getblockfrompeer},
        {"blokechain", &getblockhash},
        {"blokechain", &getblockheader},
        {"blokechain", &getchaintips},
        {"blokechain", &getdifficulty},
        {"blokechain", &getdeploymentinfo},
        {"blokechain", &gettxout},
        {"blokechain", &gettxoutsetinfo},
        {"blokechain", &pruneblokechain},
        {"blokechain", &verifychain},
        {"blokechain", &preciousblock},
        {"blokechain", &scantxoutset},
        {"blokechain", &scanblocks},
        {"blokechain", &getdescriptoractivity},
        {"blokechain", &getblockfilter},
        {"blokechain", &dumptxoutset},
        {"blokechain", &loadtxoutset},
        {"blokechain", &getchainstates},
        {"hidden", &invalidateblock},
        {"hidden", &reconsiderblock},
        {"blokechain", &waitfornewblock},
        {"blokechain", &waitforblock},
        {"blokechain", &waitforblockheight},
