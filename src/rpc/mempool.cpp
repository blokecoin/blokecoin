...
void RegisterMempoolRPCCommands(CRPCTable& t)
{
    static const CRPCCommand commands[]{
        ...
        {"blokechain", &getmempoolancestors},
        {"blokechain", &getmempooldescendants},
        {"blokechain", &getmempoolentry},
        {"blokechain", &gettxspendingprevout},
        {"blokechain", &getmempoolinfo},
        {"blokechain", &getrawmempool},
        {"blokechain", &importmempool},
        {"blokechain", &savemempool},
        {"hidden", &getorphantxs},
