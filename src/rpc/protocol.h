...
// Copyright (c) 2009-2021 The Blokecoin Core developers
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in blokecoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Blokecoin is not connected
