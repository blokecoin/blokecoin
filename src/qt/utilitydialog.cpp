    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The blokecoin-qt application provides a graphical interface for interacting with " CLIENT_NAME ".\n\n"
                         "It combines the core functionalities of blokecoind with a user-friendly interface for wallet management, transaction history, and network statistics.\n\n"
                         ...
                         "Usage: blokecoin-qt [options] [URI]\n\n";
