      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->blokecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->blokecoinAtStartup);
    ...
    ui->blokecoinAtStartup->setToolTip(ui->blokecoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->blokecoinAtStartup->setText(ui->blokecoinAtStartup->text().arg(CLIENT_NAME));

    ui->openBlokecoinConfButton->setToolTip(ui->openBlokecoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new BlokecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->blokecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBlokecoinConfButton_clicked()
{
