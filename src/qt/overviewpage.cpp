...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = BlokecoinUnits::formatWithUnit(unit, amount, true, BlokecoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    BlokecoinUnit unit{BlokecoinUnit::BTC};
...
{
    BlokecoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(BlokecoinUnits::formatWithPrivacy(unit, balances.balance, BlokecoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(BlokecoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, BlokecoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(BlokecoinUnits::formatWithPrivacy(unit, balances.immature_balance, BlokecoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(BlokecoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, BlokecoinUnits::SeparatorStyle::ALWAYS, m_privacy));
