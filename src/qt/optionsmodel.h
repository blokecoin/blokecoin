...
/** Interface from Qt to configuration data structure for Blokecoin client.
...
public:
    ...
    BlokecoinUnit getDisplayUnit() const { return m_display_blokecoin_unit; }
...
private:
    ...
    QString language;
    BlokecoinUnit m_display_blokecoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(BlokecoinUnit unit);
