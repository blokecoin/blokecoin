...
//! Call getblokechaininfo RPC and check first field of JSON output.
void TestRpcCommand(RPCConsole* console)
{
    ...
    QTest::keyClicks(lineEdit, "getblokechaininfo");
...
//! Entry point for BlokecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BlokecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BlokecoinGUI tests.
void AppTests::guiTests(BlokecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BlokecoinGUI::consoleShown, this, &AppTests::consoleTests);
