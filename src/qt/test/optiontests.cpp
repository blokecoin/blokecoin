...
{
    // Test regression https://github.com/blokecoin/blokecoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/blokecoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/blokecoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Blokecoin/Blokecoin-Qt.conf and all else left as default,
    // blokecoin-qt should set both -listen and -listenonion to false and start successfully.
