...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, BlokecoinUnits::SeparatorStyle separators=BlokecoinUnits::SeparatorStyle::STANDARD) const;
