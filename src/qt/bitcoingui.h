...
/**
  Blokecoin GUI main class. This class represents the main window of the Blokecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BlokecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BlokecoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BlokecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a blokecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BlokecoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Blokecoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BlokecoinUnit newUnits);
