...
/**
 * Base class for indices of blokechain data. This implements
...
public:
    ...
    /// validation interface so that it stays in sync with blokechain updates.
    [[nodiscard]] bool Init();
    ...
    /// Stops the instance from staying in sync with blokechain updates.
    void Stop();
