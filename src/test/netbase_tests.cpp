...
{
    BOOST_CHECK(TestSplitHost("www.blokecoincore.org", "www.blokecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.blokecoincore.org]", "www.blokecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.blokecoincore.org:80", "www.blokecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.blokecoincore.org]:80", "www.blokecoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.blokecoincore.org:65536", "www.blokecoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.blokecoincore.org:0", "www.blokecoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.blokecoincore.org:", "www.blokecoincore.org:", 0, false));
}
