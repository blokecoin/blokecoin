...
#include <kernel/blokecoinkernel.h>
#include <kernel/blokecoinkernel_wrapper.h>

#define BOOST_TEST_MODULE Blokecoin Kernel Test Suite
...
{
    Logger logger{std::make_unique<TestLog>()};
    auto test_directory{TestDirectory{"chainman_test_blokecoin_kernel"}};
...
{
    auto test_directory{TestDirectory{"mainnet_test_blokecoin_kernel"}};
...
{
    auto in_memory_test_directory{TestDirectory{"in-memory_test_blokecoin_kernel"}};
...
{
    auto test_directory{TestDirectory{"regtest_test_blokecoin_kernel"}};
