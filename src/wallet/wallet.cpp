...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const UpdateWalletTxFn& update_wtx, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/blokecoin/blokecoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/blokecoin/blokecoin/pull/13339#issuecomment-461288094
...
bool CWallet::LoadToWallet(const Txid& hash, const UpdateWalletTxFn& fill_wtx)
{
    ...
    // If wallet doesn't have a chain (e.g when using blokecoin-wallet tool),
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/blokecoin/blokecoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/blokecoin/blokecoin/pull/9371 and the prior sync
        ...
        // https://github.com/blokecoin-core/blokecoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
...
int64_t CWallet::RescanFromTime(int64_t startTime, const WalletRescanReserver& reserver, bool update)
{
    ...
    // highest blokechain timestamp, in which case there is nothing that needs
    // to be scanned.
    int start_height = 0;
    uint256 start_block;
 ...
 * https://blokecointalk.org/?topic=54527, or
 * https://github.com/blokecoin/blokecoin/pull/1393.
 */
    ...
    if (!gArgs.GetBoolArg("-walletcrosschain", DEFAULT_WALLETCROSSCHAIN)) {
        ...
        if (batch.ReadBestBlock(locator) && locator.vHave.size() > 0 && chain.getHeight()) {
            ...
            if (chain.getBlockHash(0) != locator.vHave.back()) {
                error = Untranslated("Wallet files should not be reused across chains. Restart blokecoind with -walletcrosschain to override.");
                return false;
            }
        }
    }
        ...
        if (chain.havePruned() || chain.hasAssumedValidChain()) {
            ...
            if (rescan_height != block_height) {
                ...
                error = chain.havePruned() ?
                     _("Prune: last wallet synchronisation goes beyond pruned data. You need to -reindex (download the whole blokechain again in case of a pruned node)") :
                     strprintf(_(
