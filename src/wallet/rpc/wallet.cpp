...
static const std::map<uint64_t, std::string> WALLET_FLAG_CAVEATS{
    {WALLET_FLAG_AVOID_REUSE,
     "You need to rescan the blokechain in order to correctly mark used "
...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{
        ...
        "Loads a wallet from a wallet file or directory."
                "\nNote that all wallet command-line options used when starting blokecoind will be"
