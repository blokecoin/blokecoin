...
RPCHelpMan getreceivedbyaddress()
{
    return RPCHelpMan{
        ...
        "Returns the total amount received by the given address in transactions with at least minconf confirmations.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The blokecoin address for transactions."},
...
RPCHelpMan lockunspent()
{
    return RPCHelpMan{
        ...
        "Updates list of temporarily unspendable outputs.\n"
                ...
                "A locked transaction output will not be chosen by automatic coin selection, when spending blokecoins.\n"
    ...
    return RPCHelpMan{
        ...
        "Returns array of unspent transaction outputs\n"
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, RPCArg::Default{UniValue::VARR}, "The blokecoin addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "blokecoin address"},
                        },
                    },
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::NUM, "vout", "the vout value"},
                            {RPCResult::Type::STR, "address", /*optional=*/true, "the blokecoin address"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Blokecoin address: ") + input.get_str());
            }
