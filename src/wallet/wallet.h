...
public:
    ...
    /**
     * Return depth of transaction in blokechain:
     * <0  : conflicts with a transaction this deep in the blokechain
     ...
     * blokecoin-wallet tool code or by wallet migration code. If this is called
